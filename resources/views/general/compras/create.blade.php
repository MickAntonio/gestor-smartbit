                                ...
                                <tbody id="tbody-produto">
                                    ...
                                    <tr class="gradeX" id="tr-produto-main" tabindex="4">
                                        ...
                                        <td class="width-150 td-produto-preco-1">
                                            <div class="input-group m-b col-md-12">
                                                <input type="number" value="00.00" name="preco_unitario" class="form-control preco-count">
                                            </div>
                            ...
                            <table class="table table-bordered table-hover" >
                                ...
                                <tbody>
                                    <tr class="gradeX">
                                        ...
                                        <td class="width-150">
                                            <input type="number" value="00.00" class="form-control total-desconto">
                                        </td>
   ...
   function calculatePrice(){
    ...
    $(document).on('click', '.produto-compra', function(){
        ...
        $(function(){
            ...
            $.get('http://localhost:8000/html/produto-estoque-preco/'+id+'', function(data){
