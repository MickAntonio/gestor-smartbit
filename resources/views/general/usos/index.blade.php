...
@section('content')
    ...
    <div class="row">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="/admin/usos/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> </a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" >
                        ...
                        @endphp
                            ...
                            <tr class="gradeX">
                                ...
                                <td>
                                    <a href="/admin/usos/{{$movimentacao->id}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> </a>
                                </td>
     ...
     <div class="modal inmodal" id="relatorioModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        {!! Form::open(array('route' => 'usos.pdf')) !!}   
