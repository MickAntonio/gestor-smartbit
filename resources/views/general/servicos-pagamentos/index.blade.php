...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Lista de Pagamentos dos Clientes</h5>
                    <div class="ibox-tools">
                        ...
                        <a href="/admin/pagamentos/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> </a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" >
                        ...
                        @endphp
                            ...
                            <tr class="gradeX">
                                ...
                                <td>
                                <span class="label label-warning">{{ $pagamento->pagamento }} kz</span>
                                </td>

                                <td>
                                <span class="label label-success">{{ $pagamento->forma_pagamento  }}</span>
                                ...
                                <td>
                                    <a href="/admin/pagamentos/{{$pagamento->id}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> </a>
                                </td>
                            </tr>
                            @endforeach
     ...
     <div class="modal inmodal" id="relatorioModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        {!! Form::open(array('route' => 'pagamentos.pdf')) !!}   
