                            ...
                            <table class="table table-striped table-bordered table-hover data-table-grid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info btn-sm pagar-modal"    data-id="{{ $matricula->id }}" data-nome="{{ $matricula->aluno->candidato->nome }}" data-curso="{{ $matricula->turma->curso->id }}" data-classe="{{ $matricula->turma->classe->id }}" data-saldo="00"><i class="fa fa-money"></i> </a>
                                    </td>
